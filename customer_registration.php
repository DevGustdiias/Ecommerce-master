		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading">Formulário de inscrição do cliente</div>
					...
					<form id="signup_form" onsubmit="return false">
						...
						<div class="row">
							<div class="col-md-12">
								<label for="address1">Endereço Primeira  linha</label>
								<input type="text" id="address1" name="address1"class="form-control">
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<label for="address2">Endereço Segunda linha</label>
						...
						<div class="row">
							<div class="col-md-12">
								<input style="width:100%;" value="Inscrever-se" type="submit" name="signup_button"class="btn btn-success btn-lg">
							</div>
						</div>
