		...
		<div class="row">
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					<div class="panel-heading">Finalizar Carrinho</div>
					<div class="panel-body">
						<div class="row">
							<div class="col-md-2 col-xs-2"><b>Ação</b></div>
							<div class="col-md-2 col-xs-2"><b>Imagem Produto</b></div>
							<div class="col-md-2 col-xs-2"><b>Nome Produto</b></div>
							<div class="col-md-2 col-xs-2"><b>Quantidade</b></div>
							<div class="col-md-2 col-xs-2"><b>Preço Produto</b></div>
							<div class="col-md-2 col-xs-2"><b>Preço <?php echo CURRENCY; ?></b></div>
						</div>
