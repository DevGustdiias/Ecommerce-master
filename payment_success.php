						...
						<div class="navbar navbar-inverse navbar-fixed-top">
							<div class="container-fluid">	
								...
								<ul class="nav navbar-nav">
									...
									<li><a href="profile.php"><span class="glyphicon glyphicon-modal-window"></span>Produtos</a></li>
								</ul>
							</div>
						</div>
						<p><br/></p>
								...
								<div class="col-md-8">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<h1>Obrigado </h1>
											<hr/>
											<p>Olá <?php echo "<b>".$_SESSION["name"]."</b>"; ?>,Seu processo de pagamento é concluído com sucesso e seu ID de transação é <b><?php echo $trx_id; ?></b><br/>
