	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="#" class="navbar-brand">Winter  Winnter</a>
			</div>
						...
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-md-3">Imagem Produto</div>
									<div class="col-md-3">Nome Produto</div>
							...
							<div class="panel panel-primary">
								...
								<div class="panel-heading">
									<form onsubmit="return false" id="login">
										...
										<p><br/></p>
										<a href="#" style="color:white; list-style:none;">Palavra-chave esquecida</a><input type="submit" class="btn btn-success" style="float:right;">
									</form>
								</div>
